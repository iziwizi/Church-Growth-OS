...
export function LandingHero() {
  ...
  return (
    <section className="relative isolate pt-28 pb-20 sm:pt-36 sm:pb-28 md:pt-44 md:pb-36 overflow-hidden w-full max-w-full bg-gradient-to-b from-background via-brand-50/25 to-background text-foreground">
      {/* ── Layered Light Technology Atmosphere Background ────────────── */}
      <div className="pointer-events-none absolute inset-0 -z-20 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_60%,rgba(168,85,247,0.06),transparent_70%)]" />

        {/* Elegant Technical Grid */}
      ...
      {/* ── Abstract Intelligence Network Metaphor ────────────────────── */}
      <NetworkGraph />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 w-full">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-4 sm:space-y-6">
          ...
          >
            <Link
              href="/register"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-brand-600 to-brand-700 px-7 sm:px-8 py-3.5 sm:py-4 text-xs sm:text-sm font-bold text-white shadow-xl shadow-brand-500/25 hover:from-brand-500 hover:to-brand-600 hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
            ...
            <a
              href="#how-it-works"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl border border-border/80 bg-background/80 backdrop-blur-md px-6 sm:px-7 py-3.5 sm:py-4 text-xs sm:text-sm font-semibold text-foreground hover:bg-muted transition-all shadow-xs"
            >
          ...
          >
            <span className="flex items-center gap-1.5">
              <ShieldCheck className="h-3.5 sm:h-4 w-3.5 sm:w-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
              14-Day Free Trial
            </span>
            <span className="text-border hidden sm:inline">•</span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="h-3.5 sm:h-4 w-3.5 sm:w-4 text-brand-600 dark:text-brand-400 flex-shrink-0" />
              No Credit Card Required
            </span>
            <span className="text-border hidden sm:inline">•</span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="h-3.5 sm:h-4 w-3.5 sm:w-4 text-purple-600 dark:text-purple-400 flex-shrink-0" />
        ...
        >
          ...
          <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-brand-500/15 via-purple-500/10 to-indigo-500/15 blur-xl opacity-70 pointer-events-none" />

          {/* Main Command Center Container */}
          <div className="relative rounded-2xl sm:rounded-3xl border border-border/80 bg-card/90 backdrop-blur-2xl p-3.5 sm:p-7 shadow-2xl shadow-brand-500/5 overflow-hidden ring-1 ring-border/50 space-y-4 sm:space-y-5 w-full text-foreground">
            {/* ── Centered LIVE Streaming Church Broadcast Bar ─────────────── */}
            <div className="rounded-xl sm:rounded-2xl border border-rose-500/25 bg-gradient-to-r from-rose-500/10 via-background to-brand-500/10 p-3 sm:p-4 shadow-xs flex flex-col md:flex-row items-center justify-between gap-3 w-full">
              <div className="flex items-center gap-2.5 sm:gap-3 w-full md:w-auto">
                <div className="flex items-center gap-1.5 rounded-full bg-rose-500 px-2.5 sm:px-3 py-1 text-[9px] sm:text-[10px] font-black text-white shadow-xs uppercase tracking-wider animate-pulse flex-shrink-0">
              ...
              <div className="flex items-center justify-between w-full md:w-auto gap-3 sm:gap-4 border-t md:border-t-0 border-border/60 pt-2 md:pt-0">
                ...
                <div className="text-right">
                  ...
                  <p className="text-[10px] text-emerald-600 dark:text-emerald-400 font-semibold">1080p 60fps HD Active</p>
                </div>
              </div>
            </div>

            {/* Command Center Header Bar */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-border/60 pb-3 sm:pb-4 w-full">
              ...
              {/* Interactive Tabs */}
              <div className="w-full sm:w-auto overflow-x-auto pb-1 sm:pb-0 flex items-center gap-1 bg-muted/60 p-1 rounded-xl border border-border/60 text-xs font-semibold">
                <button
                  type="button"
            ...
            <AnimatePresence mode="wait">
              {activeTab === 'overview' && (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4 w-full">
                    <div className="rounded-xl sm:rounded-2xl border border-border bg-card p-3 sm:p-4 space-y-1 sm:space-y-2 shadow-xs">
                      <div className="flex items-center justify-between text-[10px] sm:text-xs text-muted-foreground">
                        <span className="truncate">Total Members</span>
                        <Users className="h-3.5 sm:h-4 w-3.5 sm:w-4 text-brand-600 dark:text-brand-400 flex-shrink-0" />
                      </div>
                      <div className="text-base sm:text-2xl font-extrabold text-foreground">
                        {pulseCount.toLocaleString()}
                      </div>
                      <div className="text-[9px] sm:text-[10px] text-emerald-600 dark:text-emerald-400 font-semibold flex items-center gap-1 truncate">
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-border bg-card p-3 sm:p-4 space-y-1 sm:space-y-2 shadow-xs">
                      <div className="flex items-center justify-between text-[10px] sm:text-xs text-muted-foreground">
                        ...
                        <UserPlus className="h-3.5 sm:h-4 w-3.5 sm:w-4 text-purple-600 dark:text-purple-400 flex-shrink-0" />
                      </div>
                      <div className="text-base sm:text-2xl font-extrabold text-foreground">
                        68
                      </div>
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-border bg-card p-3 sm:p-4 space-y-1 sm:space-y-2 shadow-xs">
                      <div className="flex items-center justify-between text-[10px] sm:text-xs text-muted-foreground">
                        ...
                        <DollarSign className="h-3.5 sm:h-4 w-3.5 sm:w-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                      </div>
                      <div className="text-base sm:text-2xl font-extrabold text-foreground">
                        ₦4.28M
                      </div>
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-border bg-card p-3 sm:p-4 space-y-1 sm:space-y-2 shadow-xs">
                      <div className="flex items-center justify-between text-[10px] sm:text-xs text-muted-foreground">
                        ...
                        <Bot className="h-3.5 sm:h-4 w-3.5 sm:w-4 text-amber-600 dark:text-amber-400 flex-shrink-0" />
                      </div>
                      <div className="text-base sm:text-2xl font-extrabold text-foreground">
                        9 Active
                      </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-4 w-full">
                    {/* Discipleship Track */}
                    <div className="lg:col-span-7 rounded-xl sm:rounded-2xl border border-border bg-muted/20 p-3.5 sm:p-4 space-y-3 w-full">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-foreground flex items-center gap-2">
                          <Activity className="h-3.5 w-3.5 text-brand-600 dark:text-brand-400 flex-shrink-0" />
                    ...
                    <div className="lg:col-span-5 rounded-xl sm:rounded-2xl border border-border bg-muted/20 p-3.5 sm:p-4 space-y-3 w-full">
                      <span className="text-xs font-bold text-foreground flex items-center gap-2">
                        <Radio className="h-3.5 w-3.5 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="flex items-center justify-between p-2 rounded-xl bg-card border border-border shadow-2xs">
                          ...
                          <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-full flex-shrink-0 border border-emerald-500/20">
                            Verified
                          </span>
                        </div>
                        <div className="flex items-center justify-between p-2 rounded-xl bg-card border border-border shadow-2xs">
              ...
              {activeTab === 'automation' && (
                ...
                >
                  <div className="rounded-xl sm:rounded-2xl border border-brand-500/30 bg-card p-3.5 sm:p-5 space-y-3 w-full shadow-xs">
                    ...
                    <div className="bg-muted/40 p-3 sm:p-3.5 rounded-xl border border-border text-xs space-y-1.5">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pt-1 text-xs">
                      ...
                      <div className="flex items-center gap-2 w-full sm:w-auto">
                        <span className="flex-1 sm:flex-none text-center px-3 py-1.5 rounded-lg border border-border bg-background text-[11px] font-semibold text-muted-foreground hover:bg-muted cursor-pointer transition-colors">
                          Edit Copy
                        </span>
                        <span className="flex-1 sm:flex-none text-center px-3.5 py-1.5 rounded-lg bg-brand-600 text-white text-[11px] font-bold shadow-xs hover:bg-brand-500 cursor-pointer transition-colors">
                          Approve &amp; Send
                        </span>
                      </div>
                    </div>
              ...
              {activeTab === 'growth' && (
                <motion.div
                  ...
                  className="space-y-4 w-full"
                >
                  <div className="rounded-xl sm:rounded-2xl border border-border bg-card p-3.5 sm:p-5 space-y-3 w-full shadow-xs">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 text-xs">
                      <span className="font-bold text-foreground flex items-center gap-2">
                        <Clock className="h-4 w-4 text-purple-600 dark:text-purple-400 flex-shrink-0" />
                        Executive Daily 6:00 AM Pastoral Briefing
                      </span>
                      <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold bg-emerald-500/10 px-2 py-0.5 rounded-full w-fit border border-emerald-500/20">
                        Generated Automatically
                      </span>
                    </div>
                    <div className="bg-muted/40 p-3.5 sm:p-4 rounded-xl border border-border text-xs space-y-2 text-muted-foreground">
                      <p className="text-foreground font-semibold">
                        Pastor Emmanuel, here is your 24-hour ministry snapshot:
                      </p>
                      <ul className="space-y-1.5 text-[11px] list-disc list-inside text-muted-foreground">
